...
INSERT INTO `oc_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`) VALUES
(25, '', 0, 1, 1, 3, 1),
(27, '', 20, 0, 0, 2, 1),
(20, 'catalog/demo/compaq_presario.jpg', 0, 1, 1, 1, 1),
(24, '', 0, 1, 1, 5, 1),
(18, 'catalog/demo/hp_2.jpg', 0, 1, 0, 2, 1),
(17, '', 0, 1, 1, 4, 1),
(28, '', 25, 0, 0, 1, 1),
(26, '', 20, 0, 0, 1, 1),
(29, '', 25, 0, 0, 1, 1),
...
CREATE TABLE `oc_download_description` (
  ...
  `language_id` int(11) NOT NULL,
  `name` varchar(64) NOT NULL,`date_added` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `date_modified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
