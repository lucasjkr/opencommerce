<?php
class ModelSaleVoucherThemeAdmin extends Model {
	public function addVoucherTheme($data) {
		$this->db->query("INSERT INTO oc_voucher_theme SET image = '" . $this->db->escape((string)$data['image']) . "'");

		$voucher_theme_id = $this->db->getLastId();

		foreach ($data['voucher_theme_description'] as $language_id => $value) {
			$this->db->query("INSERT INTO oc_voucher_theme_description SET voucher_theme_id = '" . (int)$voucher_theme_id . "', language_id = '" . (int)$language_id . "', name = '" . $this->db->escape($value['name']) . "'");
		}
	...
	public function editVoucherTheme($voucher_theme_id, $data) {
		$this->db->query("UPDATE oc_voucher_theme SET image = '" . $this->db->escape((string)$data['image']) . "' WHERE voucher_theme_id = '" . (int)$voucher_theme_id . "'");

		$this->db->query("DELETE FROM oc_voucher_theme_description WHERE voucher_theme_id = '" . (int)$voucher_theme_id . "'");
	...
	public function deleteVoucherTheme($voucher_theme_id) {
		$this->db->query("DELETE FROM oc_voucher_theme WHERE voucher_theme_id = '" . (int)$voucher_theme_id . "'");
		$this->db->query("DELETE FROM oc_voucher_theme_description WHERE voucher_theme_id = '" . (int)$voucher_theme_id . "'");
	...
	public function getTotalVoucherThemes() {
		$query = $this->db->query("SELECT COUNT(*) AS total FROM oc_voucher_theme");
