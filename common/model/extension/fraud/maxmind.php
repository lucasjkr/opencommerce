...
class ModelExtensionFraudMaxMind extends Model {
	public function check($order_info) {
		...
		$query = $this->db->query("SELECT * FROM `oc_maxmind` WHERE order_id = '" . (int)$order_info['order_id'] . "'");
