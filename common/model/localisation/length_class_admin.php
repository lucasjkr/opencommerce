...
class ModelLocalisationLengthClassAdmin extends Model {
	public function addLengthClass($data) {
		$this->db->query("INSERT INTO oc_length_class SET value = :value",
            [
                ':value' => $data['value']
            ]);
	...
	public function editLengthClass($length_class_id, $data) {
		$this->db->query("UPDATE oc_length_class SET value = :value WHERE length_class_id = :length_class_id",
            [
                ':value' => $data['value'],
                ':length_class_id' => $length_class_id
            ]);

		$this->db->query("DELETE FROM oc_length_class_description WHERE length_class_id = :length_class_id",
            [
                ':length_class_id' => $length_class_id
            ]);
	...
	public function deleteLengthClass($length_class_id) {
		$this->db->query("DELETE FROM oc_length_class WHERE length_class_id = :length_class_id",
            [
                ':length_class_id' => $length_class_id
            ]);
		$this->db->query("DELETE FROM oc_length_class_description WHERE length_class_id = :length_class_id",
	...
	public function getLengthClass($length_class_id) {
		$query = $this->db->query("SELECT * FROM oc_length_class lc LEFT JOIN oc_length_class_description lcd ON (lc.length_class_id = lcd.length_class_id) WHERE lc.length_class_id = :length_class_id AND lcd.language_id = :language_id",
            [
                ':length_class_id' => $length_class_id,
                ':language_id' => $this->config->get('config_language_id'),
            ]);
	...
	public function getLengthClassDescriptionByUnit($unit) {
		$query = $this->db->query("SELECT * FROM oc_length_class_description WHERE unit = :unit AND language_id = :language_id",
            [
                ':unit' => $unit,
                ':language_id' => $this->config->get('config_language_id'),
            ]);
	...
	public function getLengthClassDescriptions($length_class_id) {
		...
		$query = $this->db->query("SELECT * FROM oc_length_class_description WHERE length_class_id = :length_class_id",
            [
                ':length_class_id' => $length_class_id
            ]);
