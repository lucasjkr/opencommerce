...
class ModelCatalogReview extends Model {
	public function addReview($product_id, $data) {
		$this->db->query("INSERT INTO oc_review SET author = '" . $this->db->escape((string)$data['name']) . "', customer_id = '" . (int)$this->customer->getId() . "', product_id = '" . (int)$product_id . "', text = '" . $this->db->escape((string)$data['text']) . "', rating = '" . (int)$data['rating'] . "', date_added = NOW()");
