...
class ControllerExtensionPaymentBluePayRedirect extends Controller {
	...
	public function send() {
		...
		$post_data['APPROVED_URL'] = $this->url->link('extension/payment/bluepay_redirect/callback', '');
		$post_data['DECLINED_URL'] = $this->url->link('extension/payment/bluepay_redirect/callback', '');
		$post_data['MISSING_URL'] = $this->url->link('extension/payment/bluepay_redirect/callback', '');
