...
class ControllerExtensionPaymentFirstdata extends Controller {
	public function index() {
		...
		$data['url_success'] = $this->url->link('checkout/success', '');
		$data['url_fail'] = $this->url->link('extension/payment/firstdata/fail', '');
		$data['url_notify'] = $this->url->link('extension/payment/firstdata/notify', '');
