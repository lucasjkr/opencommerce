...
class ControllerExtensionPaymentPPPayflow extends Controller {
	...
	public function index() {
		...
		$data['breadcrumbs'][] = array(
			...
			'href' => $this->url->link('extension/payment/pp_payflow', 'user_token=' . $this->session->data['user_token']),
		);

		$data['action'] = $this->url->link('extension/payment/pp_payflow', 'user_token=' . $this->session->data['user_token']);
