...
class ControllerExtensionModulePPBraintreeButton extends Controller {
	public function index() {
		...
		if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
			$this->model_setting_setting_admin->editSetting('module_pp_braintree_button', $this->request->post);
	...
	public function install() {
		...
		$this->model_setting_setting_admin->editSetting('module_pp_braintree_button', $settings);
	}
