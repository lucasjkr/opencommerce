...
//			}
			...
			$complete_total = $this->model_report_statistics_admin->getValue('order_complete');
			...
			$processing_total = $this->model_report_statistics_admin->getValue('order_processing');
			...
			$other_total = $this->model_report_statistics_admin->getValue('order_other');
