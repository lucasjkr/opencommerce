		...
		if (!$json) {
			...
			foreach ($files as $file) {
				if (is_file($file['tmp_name'])) {
					...
					// LJK TODO: I think these are also defined in config_settings - should be done in one place or another, not both.
                    // Prefer to use settings, except for a few extreme cases (disallow .php, for instance)
                    $allowed = [
						'jpg',
						'jpeg',
						'gif',
