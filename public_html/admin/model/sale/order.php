...
class ModelSaleOrder extends Model {
	...
	public function getTotalOrdersByProcessingStatus() {
		...
		if ($implode) {
			$query = $this->db->query("SELECT COUNT(*) AS total FROM `oc_order` WHERE " . implode(" OR ", $implode));
	...
	public function getEmailsByProductsOrdered($products, $start, $end) {
		...
		$query = $this->db->query("SELECT DISTINCT email FROM `oc_order` o LEFT JOIN oc_order_product op ON (o.order_id = op.order_id) WHERE (" . implode(" OR ", $implode) . ") AND o.order_status_id <> '0' LIMIT " . (int)$start . "," . (int)$end);
	...
	public function getTotalEmailsByProductsOrdered($products) {
		...
		$query = $this->db->query("SELECT COUNT(DISTINCT email) AS total FROM `oc_order` o LEFT JOIN oc_order_product op ON (o.order_id = op.order_id) WHERE (" . implode(" OR ", $implode) . ") AND o.order_status_id <> '0'");
