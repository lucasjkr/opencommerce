...
class StarterData extends AbstractMigration
{
...
");
        $this->execute("INSERT INTO `oc_category_path` (`category_id`, `path_id`, `level`) VALUES
(25, 25, 0),
(28, 25, 0),
(28, 28, 1),
(35, 25, 0),
...
");
        ...
        $this->execute("INSERT INTO `oc_category_to_store` (`category_id`, `store_id`) VALUES
(17, 0),
(18, 0),
(20, 0),
(24, 0),
...
(58, 0);");
        ...
        $this->execute("INSERT INTO `oc_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`) VALUES
...
");
        ...
        $this->execute("INSERT INTO `oc_customer_group` (`customer_group_id`, `approval`, `sort_order`) VALUES
(1, 0, 1);");

        $this->execute("INSERT INTO `oc_customer_group_description` (`customer_group_id`, `language_id`, `name`, `description`) VALUES
(1, 1, 'Default', 'test');");

        $this->execute("INSERT INTO `oc_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
...
(3, 'Euro', 'EUR', '', '€', '2', 0.78460002, 1, '2014-09-25 14:40:00');");
        ...
        $this->execute("INSERT INTO `oc_event` (`event_id`, `code`, `trigger`, `action`, `status`) VALUES
...
(33, 'admin_mail_forgotten', 'admin/model/user/user/editCode/after', 'mail/forgotten', 1);");
        ...
        $this->execute("INSERT INTO `oc_extension` (`extension_id`, `type`, `code`) VALUES
(1, 'payment', 'cod'),
(2, 'total', 'shipping'),
(3, 'total', 'sub_total'),
(4, 'total', 'tax'),
...
(41, 'report', 'customer_reward');");
        ...
        $this->execute("INSERT INTO `oc_geo_zone` (`geo_zone_id`, `name`, `description`, `date_modified`, `date_added`) VALUES
(3, 'UK VAT Zone', 'UK VAT', '2010-02-26 22:33:24', '2009-01-06 23:26:25'),
(4, 'UK Shipping', 'UK Shipping Zones', '2010-12-15 15:18:13', '2009-06-23 01:14:53');
");

        $this->execute("INSERT INTO `oc_information` (`information_id`, `bottom`, `sort_order`, `status`) VALUES
(3, 1, 3, 1),
(4, 1, 1, 1),
(5, 1, 4, 1),
(6, 1, 2, 1);
");
        ...
        $this->execute("INSERT INTO `oc_information_description` (`information_id`, `language_id`, `title`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(4, 1, 'About Us', '&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n', 'About Us', '', ''),
(5, 1, 'Terms &amp; Conditions', '&lt;p&gt;\r\n	Terms &amp;amp; Conditions&lt;/p&gt;\r\n', 'Terms &amp; Conditions', '', ''),
(3, 1, 'Privacy Policy', '&lt;p&gt;\r\n	Privacy Policy&lt;/p&gt;\r\n', 'Privacy Policy', '', ''),
(6, 1, 'Delivery Information', '&lt;p&gt;\r\n	Delivery Information&lt;/p&gt;\r\n', 'Delivery Information', '', '');");

        $this->execute("INSERT INTO `oc_information_to_store` (`information_id`, `store_id`) VALUES
(3, 0),
(4, 0),
(5, 0),
(6, 0);");

        $this->execute("INSERT INTO `oc_language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `sort_order`, `status`) VALUES
(1, 'English', 'en-gb', 'en-gb,en', 'gb.png', 'english', 1, 1);");

        $this->execute("INSERT INTO `oc_layout` (`layout_id`, `name`) VALUES
(1, 'Home'),
(2, 'Product'),
(3, 'Category'),
(4, 'Default'),
...
(13, 'Search');");
        ...
        $this->execute("INSERT INTO `oc_layout_module` (`layout_module_id`, `layout_id`, `code`, `position`, `sort_order`) VALUES
(2, 4, '0', 'content_top', 0),
(3, 4, '0', 'content_top', 1),
...
(73, 3, 'banner.30', 'column_left', 2);");
        ...
        $this->execute("INSERT INTO `oc_layout_route` (`layout_route_id`, `layout_id`, `store_id`, `route`) VALUES
(38, 6, 0, 'account/%'),
(17, 10, 0, 'affiliate/%'),
...
(53, 13, 0, 'product/search');");
        ...
        $this->execute("INSERT INTO `oc_length_class` (`length_class_id`, `value`) VALUES
(1, '1.00000000'),
(2, '10.00000000'),
(3, '0.39370000');
");

        $this->execute("INSERT INTO `oc_length_class_description` (`length_class_id`, `language_id`, `title`, `unit`) VALUES
(1, 1, 'Centimeter', 'cm'),
(2, 1, 'Millimeter', 'mm'),
(3, 1, 'Inch', 'in');
");

        $this->execute("INSERT INTO `oc_manufacturer` (`manufacturer_id`, `name`, `image`, `sort_order`) VALUES
...
");
        ...
        $this->execute("INSERT INTO `oc_manufacturer_to_store` (`manufacturer_id`, `store_id`) VALUES
(5, 0),
(6, 0),
(7, 0),
(8, 0),
...
(31, 'Banner 1', 'banner', '{\"name\":\"Banner 1\",\"banner_id\":\"6\",\"width\":\"182\",\"height\":\"182\",\"status\":\"1\"}');
        ...
        $this->execute("INSERT INTO `oc_option` (`option_id`, `type`, `sort_order`) VALUES
(1, 'radio', 1),
(2, 'checkbox', 2),
(4, 'text', 3),
(5, 'select', 4),
...
(440, 42, 1, 30, 1, '66.0000', '2014-01-01', '2016-12-31'),
(439, 42, 1, 20, 1, '77.0000', '2014-01-01', '2016-12-31'),
(438, 42, 1, 10, 1, '88.0000', '2014-01-01', '2016-12-31');
");
...
");
        ...
        $this->execute("INSERT INTO `oc_product_special` (`product_special_id`, `product_id`, `customer_group_id`, `priority`, `price`, `date_start`, `date_end`) VALUES
(419, 42, 1, 1, '90.0000', '2014-01-01', '2016-12-31'),
(439, 30, 1, 2, '90.0000', '2014-01-01', '2016-12-31'),
(438, 30, 1, 1, '80.0000', '2014-01-01', '2016-12-31');
");

        $this->execute("INSERT INTO `oc_product_to_category` (`product_id`, `category_id`) VALUES
(28, 20),
(28, 24),
(29, 20),
(29, 24),
...
");
        ...
        $this->execute("INSERT INTO `oc_product_to_store` (`product_id`, `store_id`) VALUES
(28, 0),
(29, 0),
(30, 0),
(31, 0),
...
");
        ...
        $this->execute("INSERT INTO `oc_setting` (`store_id`, `code`, `key`, `value`, `serialized`) VALUES
...
");
        ...
        $this->execute("INSERT INTO `oc_zone` (`zone_id`, `country_id`, `name`, `code`, `status`) VALUES
...
(1, 222, 0, 4, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(2, 222, 3513, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(3, 222, 3514, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(4, 222, 3515, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(5, 222, 3516, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(6, 222, 3517, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(7, 222, 3518, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(8, 222, 3519, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(9, 222, 3520, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(10, 222, 3521, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(11, 222, 3522, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(12, 222, 3523, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(13, 222, 3524, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(14, 222, 3525, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(15, 222, 3526, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(16, 222, 3527, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(17, 222, 3528, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(18, 222, 3529, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(19, 222, 3530, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(20, 222, 3531, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(21, 222, 3532, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(22, 222, 3533, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(23, 222, 3534, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(24, 222, 3535, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(25, 222, 3536, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(26, 222, 3537, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(27, 222, 3538, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(28, 222, 3539, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(29, 222, 3540, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(30, 222, 3541, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(31, 222, 3542, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(32, 222, 3543, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(33, 222, 3544, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(34, 222, 3545, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(35, 222, 3546, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(36, 222, 3547, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(37, 222, 3548, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(38, 222, 3549, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(39, 222, 3550, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(40, 222, 3551, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(41, 222, 3552, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(42, 222, 3553, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(43, 222, 3554, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(44, 222, 3555, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(45, 222, 3556, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(46, 222, 3557, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(47, 222, 3558, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(48, 222, 3559, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(49, 222, 3560, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(50, 222, 3561, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(51, 222, 3562, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(52, 222, 3563, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(53, 222, 3564, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(54, 222, 3565, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(55, 222, 3566, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(56, 222, 3567, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(57, 222, 3568, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(58, 222, 3569, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(59, 222, 3570, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(60, 222, 3571, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(61, 222, 3572, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(62, 222, 3573, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(63, 222, 3574, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(64, 222, 3575, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(65, 222, 3576, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(66, 222, 3577, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(67, 222, 3578, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(68, 222, 3579, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(69, 222, 3580, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(70, 222, 3581, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(71, 222, 3582, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(72, 222, 3583, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(73, 222, 3584, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(74, 222, 3585, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(75, 222, 3586, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(76, 222, 3587, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(77, 222, 3588, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(78, 222, 3589, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(79, 222, 3590, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(80, 222, 3591, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(81, 222, 3592, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(82, 222, 3593, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(83, 222, 3594, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(84, 222, 3595, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(85, 222, 3596, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(86, 222, 3597, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(87, 222, 3598, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(88, 222, 3599, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(89, 222, 3600, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(90, 222, 3601, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(91, 222, 3602, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(92, 222, 3603, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(93, 222, 3604, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(94, 222, 3605, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(95, 222, 3606, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(96, 222, 3607, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(97, 222, 3608, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(98, 222, 3609, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(99, 222, 3610, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(100, 222, 3611, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(101, 222, 3612, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(102, 222, 3949, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(103, 222, 3950, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(104, 222, 3951, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(105, 222, 3952, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(106, 222, 3953, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(107, 222, 3954, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(108, 222, 3955, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56'),
(109, 222, 3972, 3, '2017-06-17 12:34:56', '2017-06-17 12:34:56');
");
